...
\textbf{Step 3} uses the regime specific parameters $\Phi^{(m)}$ to make a maximum \textit{a posteriori} (MAP) assignment of an observation to a regime using the Viterbi algorithm, thereby specifying the value of $S_t \forall t \in [1:T]$.
